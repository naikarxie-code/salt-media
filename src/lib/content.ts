...
export const NARRATIVE_FORMATS = [
  {
    title: "Branded Entertainment & AFP",
    description:
      "Long-form branded content created in partnership with platforms through the Advertiser Funded Programming model.",
  },
  {
    title: "Branded Mini-Series",
    description:
      "Multi-episode narrative series co-developed with brands, designed for digital-first distribution.",
  },
  {
    title: "Docu-Entertainment",
    description:
      "Documentary-style entertainment that blends real stories with cinematic production value.",
  },
  {
    title: "Reality / Challenge Formats",
    description:
      "Competition and reality formats designed for high engagement and brand integration opportunities.",
  },
  {
    title: "Festival / Tentpole Specials",
    description:
      "Event-based content tied to cultural moments, festivals, and tentpole occasions.",
  },
  {
    title: "Micro-Drama Spin-offs",
    description:
      "Short-form narrative content derived from larger IPs, optimized for mobile-first consumption.",
  },
  {
    title: "Integrated Ad Films",
    description:
      "Premium advertising content that blurs the line between traditional ads and entertainment storytelling.",
  },
];
...
export const STRATEGY = {
  codevelopmentModel: {
    ...
    phases: [
      ...
      {
        phase: "02",
        title: "Co-Development & IP Creation",
        description:
...
export const SECTIONS = [
  ...
  { id: "opportunity", label: "Opportunity", number: "03" },
  { id: "ecosystem", label: "Ecosystem", number: "04" },
