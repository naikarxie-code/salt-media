    ...
    >
      ...
      <Reveal>
        <div className="relative z-10 flex items-center gap-4 mb-4">
          <span className="text-amber-400 font-mono text-sm font-semibold">08B</span>
      ...
      <Reveal>
        ...
        <p className="relative z-10 text-base md:text-lg text-neutral-300 max-w-3xl mb-10 font-light">
      ...
      <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        {OUTPUT_STACK.map((item, idx) => (
          <Reveal key={idx} delay={idx * 0.08}>
            <div className="p-6 rounded-2xl border border-neutral-800 bg-neutral-950/80 backdrop-blur-xl hover:border-amber-400/50 hover:bg-neutral-900/60 transition-all duration-300 shadow-xl flex flex-col justify-between h-full group">
              <div>
                ...
                <h3 className="text-lg font-bold text-white uppercase tracking-wider mb-2 group-hover:text-amber-300 transition-colors">
                  {item.level}
                </h3>
              ...
              <div className="mt-5 pt-3 border-t border-neutral-800/80 text-[10px] font-mono text-neutral-500 uppercase flex justify-between">
